...
def create_page(request):
    ...
    if request.user.is_authenticated():
       content=""
       return render_to_response("create.html",{"content":content},context_instance=RequestContext(request))
    else:
...
def view_page(request,page_id):
    ...
    return render_to_response("view.html",{"page_title":page_title,"content":page_content,"page_id":page_id})
...
def edit_page(request,page_id):
    ...
    page_title=page.title
    page_content=history.objects.filter(page_id=page_id).latest('edited').content
    return render_to_response("edit.html",{"page_title":page_title,"content":page_content,"page_id":page_id},context_instance=RequestContext(request))
...
def save_edit(request,page_id):
    ...
    newchange=history(page_id=page,content=page_content,edited_by=loggedin_user)
    newchange.save()
